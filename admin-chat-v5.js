...
(function(){
  ...
  function ensure(){
    ...
    btn.onclick=function(){ showTab('chat',btn); loadChatThreads(true); };
    ...
    s.textContent=
      '#chatUnreadBadge:not(:empty){background:#8e4c9f;color:#fff;border-radius:99px;padding:2px 5px;font-size:8px}'+
      ...
      '.admin-chat-list{overflow:auto;border-right:1px solid #e8dfe9;background:#faf7fb}.admin-chat-card{padding:14px 15px;border:0;border-bottom:1px solid #ebe3ed;background:transparent;width:100%;text-align:left;cursor:pointer}.admin-chat-card.active,.admin-chat-card:hover{background:#efe5f2}'+
      ...
      '.admin-chat-convo{display:grid;grid-template-rows:auto 1fr auto;min-width:0}.admin-chat-placeholder{display:grid;place-items:center;grid-row:1/-1;color:#8b7c8f;font:500 26px "Cormorant Garamond",serif}'+
      ...
      '.admin-chat-messages{overflow:auto;padding:17px;background:#fcfafc;display:flex;flex-direction:column;gap:9px}.admin-chat-msg{width:max-content;max-width:80%;padding:9px 11px;border-radius:12px;font-size:11px;line-height:1.55;word-break:break-word}.admin-chat-msg.from-customer{align-self:flex-start;background:#fff;border:1px solid #e1d7e4}.admin-chat-msg.from-admin{align-self:flex-end;background:#6c3f7d;color:#fff}'+
      ...
      '@media(max-width:900px){.admin-chat-shell{grid-template-columns:1fr;height:auto}.admin-chat-list{max-height:240px}.admin-chat-convo{height:570px}}';
