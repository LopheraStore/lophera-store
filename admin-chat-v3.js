...
(function(){
  ...
  function ensure(){
    ...
    const s=document.createElement('style');s.id='admin-chat-style';s.textContent=`
      ...
      .admin-chat-messages{overflow:auto;padding:17px;background:#fcfafc;display:flex;flex-direction:column;gap:9px}.admin-chat-msg{display:block;width:max-content;max-width:78%;min-height:0;height:auto;flex:0 0 auto;padding:9px 11px;border-radius:12px;font-size:11px;line-height:1.55;word-break:break-word}.admin-chat-msg.from-customer{align-self:flex-start;background:#fff;border:1px solid #e1d7e4;border-bottom-left-radius:4px}.admin-chat-msg.from-admin{align-self:flex-end;background:#6c3f7d;color:#fff;border-bottom-right-radius:4px}.admin-chat-msg small{display:block;font-size:7px;opacity:.62;margin-top:4px}
